...
import logo from '../images/KUSH.jpg';
...
export default function Sidebar() {
  ...
  const iconList = [
    ...
    {
      component: twitter,
      href: 'https://twitter.com/kushjindalka11'
    },
    {
      component: instagram,
      href: 'https://instagram.com/kushjindal_?igshid=NTc4MTIwNjQ2YQ=='
    },
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      ...
      <p style={{ color: 'white', fontWeight: 'bold' }} className='gmail'>
        <a
          href='mailto:Kushjindal1403@outlook.com'
      ...
      <ul className='sidebar-nav'>
        ...
        <li className='sidebar-nav-items'>
          <Link smooth to='/#certificates' className='links'>
            Certificates
          </Link>
        </li>
      </ul>
